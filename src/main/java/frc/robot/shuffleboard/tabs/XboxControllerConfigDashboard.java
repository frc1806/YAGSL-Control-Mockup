...
public class XboxControllerConfigDashboard {
    ...
    private static final XboxControllerConfigValues NETWORK_TABLE_FAILURE_FALLBACK_VALUES = XboxControllerConfigValues.Builder
            .create().withLeftXDeadzone(.4).withLeftXMinimumOutput(.4).withLeftXLinearity(.99).withLeftYDeadzone(.4)
            .withLeftYMinimumOutput(.4).withLeftYLinearity(.99).withRightXDeadzone(.4).withRightXMinimumOutput(.4)
            .withRightXLinearity(.99).withRightYDeadzone(.4).withRightYMinimumOutput(.4).withRightYLinearity(.99)
